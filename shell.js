...
(function() {
  var FILTER_EXCLUDED, FILTER_INCLUDED, FILTER_STOPPED, InterfacedObject, LOADING_STATES, NotFoundError, OBJECT_STATES, PATH_SEP, ReadError, ReadStream, SUBKEY_SEP, WriteStream, addpre, assignDeprecatedPrefixOption, deprecate, dispatchError, errors, getPathArray, inherits, isFunction, isObject, isString, levelUtil, path, pathArrayToPath, precodec, resolveKeyPath, setImmediate, sublevel, through, util, version, _nut;
  ...
  sublevel = module.exports = function(nut, aCreateReadStream, aCreateWriteStream) {
    ...
    Subkey = (function() {
      ...
      Subkey.prototype.final = function() {
        var event, i, listener, unhooks, _ref, _results;
        this.freeSubkeys();
        this._value = void 0;
        if (this._realKey) {
          this._realKey.free();
